...
public class OriginalOriginContent {
    ...
    public static @Nullable ItemStack @NotNull [] EnderianContents(){
        ...
        ender_origin_info4 = itemPropertiesMultipleLore(ender_origin_info4, UNDERLINE + "Slender Body", null, null, Arrays.asList(WHITE + "You can reach farther than everyone due to your", WHITE + "long arms, but you are too weak to mine"));
