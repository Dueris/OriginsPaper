...
public class MainMenuContents {
    ...
    public static @Nullable ItemStack @NotNull [] GenesisMainMenuContents(Player p) {
        ...
        if (originNames.containsKey("origins:human"))
        ...
        if (originNames.containsKey("origins:enderian"))
        ...
        if (originNames.containsKey("origins:shulk"))
        ...
        if (originNames.containsKey("origins:arachnid"))
        ...
        if (originNames.containsKey("origins:creep"))
        ...
        if (originNames.containsKey("origins:phantom"))
        ...
        if (originNames.containsKey("origins:slimeling"))
        ...
        if (originNames.containsKey("origins:feline"))
        ...
        if (originNames.containsKey("origins:blazeborn"))
        ...
        if (originNames.containsKey("origins:starborne"))
        ...
        if (originNames.containsKey("origins:merling"))
        ...
        if (originNames.containsKey("origins:allay"))
        ...
        if (originNames.containsKey("origins:rabbit"))
        ...
        if (originNames.containsKey("origins:bee"))
        ...
        if (originNames.containsKey("origins:elytrian"))
        ...
        if (originNames.containsKey("origins:avian"))
        ...
        if (originNames.containsKey("origins:piglin"))
        ...
        if (originNames.containsKey("origins:sculkling"))
