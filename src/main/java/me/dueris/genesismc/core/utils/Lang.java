...
public class Lang {
    ...
    public static File getLangFile() {
        ...
        String filePath = GenesisMC.getPlugin().getDataFolder() + File.separator + "lang" + File.separator + "datapacks"  + File.separator + "langFiles" + File.separator + langFileName + ".yml";
