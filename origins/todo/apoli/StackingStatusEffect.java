...
public class StackingStatusEffect extends PowerType {
	...
	public static FactoryData registerComponents(FactoryData data) {
		return PowerType.registerComponents(data).ofNamespace(OriginsPaper.apoliIdentifier("stacking_status_effect"))
	...
	public void apoli$StackingStatusEffectPower$applyEffects(LivingEntity entity) {
		...
		effectInstances.forEach(sei -> {
			...
			if (duration > 0) {
				...
				// OriginsPaper - Paper/Spigot makers lots of changes to potion effects, making it work differently. This fixes it
