...
public class ModifyStatusEffectDurationPower extends ModifierPower {
	...
	public ModifyStatusEffectDurationPower(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionFactory<Entity> condition, int loadingPriority,
