...
public class BiEntityActions {
	...
	public static ActionTypeFactory<Tuple<Entity, Entity>> register(ActionTypeFactory<Tuple<Entity, Entity>> actionFactory) {
		return OriginsPaper.getRegistry().retrieve(Registries.BIENTITY_ACTION).register(actionFactory, actionFactory.getSerializerId());
	}
