...
public class ActionOnEntityUsePowerType extends ActiveInteractionPowerType {
	...
	public static PowerTypeFactory<?> getFactory() {
		return new PowerTypeFactory<>(
			OriginsPaper.apoliIdentifier("action_on_entity_use"),
	...
	public boolean shouldExecute(Entity other, InteractionHand hand, ItemStack heldStack, @NotNull PriorityPhase priorityPhase) {
	...
	public InteractionResult executeAction(Entity other, InteractionHand hand) {
		...
		this.performActorItemStuff(this, (Player) entity, hand);
