...
public class ActionOnBeingUsedPower extends PowerType {
	...
	public ActionOnBeingUsedPower(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionTypeFactory<Entity> condition, int loadingPriority,
								  ActionTypeFactory<Tuple<Entity, Entity>> biEntityAction, ConditionTypeFactory<Tuple<Entity, Entity>> bientityCondition, ConditionTypeFactory<Tuple<Level, ItemStack>> itemCondition, EnumSet<InteractionHand> hands,
								  ItemStack resultStack, ActionTypeFactory<Tuple<Level, SlotAccess>> heldItemAction, ActionTypeFactory<Tuple<Level, SlotAccess>> resultItemAction) {
	...
	public static @NotNull PowerTypeFactory getFactory() {
		return new PowerTypeFactory(OriginsPaper.apoliIdentifier("action_on_being_used"), PowerType.getFactory().getSerializableData()
