...
public class GiveActionType {
	...
	public static void action(@NotNull Entity entity, ItemStack newStack, Consumer<Tuple<Level, SlotAccess>> itemAction, @Nullable EquipmentSlot preferredSlot) {

		if (entity.level().isClientSide || newStack.isEmpty()) {
			return;
		}

		SlotAccess stackReference = Util.createStackReference(newStack);
		...
		if (entity instanceof Player player) {
			...
			Util.throwItem(entity, stackToGive, false, false);
		}
