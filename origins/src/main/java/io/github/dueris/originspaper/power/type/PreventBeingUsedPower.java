...
public class PreventBeingUsedPower extends PowerType {
	...
	public PreventBeingUsedPower(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionTypeFactory<Entity> condition, int loadingPriority,
	...
	public static @NotNull PowerTypeFactory getFactory() {
		return new PowerTypeFactory(OriginsPaper.apoliIdentifier("prevent_being_used"), PowerType.getFactory().getSerializableData()
