...
public class BlockStateBlockConditionType extends BlockConditionType {
	...
	public boolean test(Level world, BlockPos pos, BlockState blockState, Optional<BlockEntity> blockEntity) {
		...
		return switch (propertyValue) {
			case Enum<?> enumProp when enumValue != null -> enumProp.name().equalsIgnoreCase(enumValue);
			case Boolean boolProp when boolValue != null -> boolProp == boolValue;
			case Integer intProp when comparison != null && compareTo != null -> comparison.compare(intProp, compareTo);
