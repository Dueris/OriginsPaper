...
public class SelfActionOnKillPowerType extends CooldownPowerType {
	...
	public SelfActionOnKillPowerType(Power power, LivingEntity entity, Consumer<Entity> entityAction, Predicate<Entity> targetCondition, Predicate<Tuple<DamageSource, Float>> damageCondition, HudRender hudRender, int cooldownDuration) {
