...
public class SelfActionOnKillPowerType extends CooldownPowerType {
	...
	public static final TypedDataObjectFactory<SelfActionOnKillPowerType> DATA_FACTORY = PowerType.createConditionedDataFactory(
		...
		(data, condition) -> new SelfActionOnKillPowerType(
	...
	public SelfActionOnKillPowerType(EntityAction entityAction, Optional<EntityCondition> targetCondition, Optional<DamageCondition> damageCondition, HudRender hudRender, int cooldownDuration, Optional<EntityCondition> condition) {
