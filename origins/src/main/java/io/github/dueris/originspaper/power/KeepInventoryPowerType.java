...
public class KeepInventoryPowerType extends PowerType {
	...
	public KeepInventoryPowerType(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionFactory<Entity> condition, int loadingPriority,
	...
	public static InstanceDefiner buildFactory() {
		return PowerType.buildFactory().typedRegistry(OriginsPaper.apoliIdentifier("keep_inventory"))
	...
	private void markKeep(@NotNull PlayerDeathEvent e, org.bukkit.inventory.ItemStack stack) {
