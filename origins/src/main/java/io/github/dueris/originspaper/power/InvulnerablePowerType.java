...
public class InvulnerablePowerType extends PowerType {
	...
	public InvulnerablePowerType(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionFactory<Entity> condition, int loadingPriority,
