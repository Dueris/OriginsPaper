...
public class SelfActionOnKillPower extends PowerType implements CooldownInterface {
	...
	public SelfActionOnKillPower(@NotNull ResourceLocation key, @NotNull ResourceLocation type, Component name, Component description, boolean hidden, ConditionFactory<Entity> condition, int loadingPriority,
