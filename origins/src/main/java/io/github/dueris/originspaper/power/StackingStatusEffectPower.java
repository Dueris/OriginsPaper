...
public class StackingStatusEffectPower extends StatusEffectPower {
	...
	public static SerializableData buildFactory() {
		return PowerType.buildFactory().typedRegistry(OriginsPaper.apoliIdentifier("stacking_status_effect"))
	...
	@Override
	public void applyEffects(LivingEntity entity, int currentStack) {
		effects.forEach(sei -> {
