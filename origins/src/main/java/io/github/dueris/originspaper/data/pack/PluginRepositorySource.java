...
public class PluginRepositorySource implements RepositorySource {
	...
	public PluginRepositorySource(Path packsDir, PackType type, PackSource source, DirectoryValidator symlinkFinder, String fileName) {
	...
	public static void discoverPacks(Path path, DirectoryValidator symlinkFinder, BiConsumer<Path, Pack.ResourcesSupplier> callback, String fileName) throws IOException {
		PluginRepositorySource.FolderPackDetector folderPackDetector = new PluginRepositorySource.FolderPackDetector(symlinkFinder, fileName);
