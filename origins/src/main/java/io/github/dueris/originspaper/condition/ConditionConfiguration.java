...
public record ConditionConfiguration<T extends AbstractConditionType<?, ?>>(ResourceLocation id, TypedDataObjectFactory<T> dataFactory) implements TypeConfiguration<T> {
