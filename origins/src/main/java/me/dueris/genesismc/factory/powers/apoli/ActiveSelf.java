...
public class ActiveSelf extends PowerType implements KeyedPower, CooldownPower {
	...
	public ActiveSelf(String name, String description, boolean hidden, FactoryJsonObject condition, int loading_priority, FactoryJsonObject entityAction, int cooldown, FactoryJsonObject hudRender, FactoryJsonObject key) {
