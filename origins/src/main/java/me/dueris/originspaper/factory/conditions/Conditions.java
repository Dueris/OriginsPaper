...
public class Conditions {
	...
	public static <T> void registerPackage(@NotNull Consumer<ConditionFactory<T>> factoryConsumer, String subPackage) {
		try {
			ScanResult result = new ClassGraph().whitelistPackages("me.dueris.originspaper.factory.conditions.types." + subPackage).enableClassInfo().scan();
