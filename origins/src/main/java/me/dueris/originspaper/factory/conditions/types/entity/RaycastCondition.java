...
public class RaycastCondition {
	...
	private static EntityHitResult performEntityRaycast(@NotNull Entity source, Vec3 origin, @NotNull Vec3 target, ConditionFactory<Pair<Entity, Entity>> biEntityCondition) {
