...
public class ModifyDamageDealtPower extends ModifierPower implements Listener {
	...
	public static FactoryData registerComponents(FactoryData data) {
		return ModifierPower.registerComponents(data).ofNamespace(OriginsPaper.apoliIdentifier("modify_damage_dealt"))
	...
	public static void runSetDMG(@NotNull EntityDamageByEntityEvent e, String operation, float value) {
	...
	public void damageEVENT(@NotNull EntityDamageByEntityEvent e) {
