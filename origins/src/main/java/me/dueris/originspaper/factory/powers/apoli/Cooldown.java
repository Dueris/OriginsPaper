...
import static me.dueris.originspaper.factory.powers.apoli.Resource.currentlyDisplayed;
import static me.dueris.originspaper.factory.powers.apoli.Resource.serverLoadedBars;
...
public class Cooldown extends PowerType implements CooldownPower {
	...
	public static FactoryData registerComponents(FactoryData data) {
		return PowerType.registerComponents(data).ofNamespace(OriginsPaper.apoliIdentifier("cooldown"))
